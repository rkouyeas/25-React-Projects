...
export const data: accordianData[] = [
  {
    id: 1,
  ...
  },
  {
    ...
    answer:
      "The accordian is a musical insturment with a keyboard and bellows. It produces sound by pressing air over reeds when the player expands or compresses the bellows, used in various music genres.",
  },
  {
    id: 4,
